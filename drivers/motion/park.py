...
#
#Description:
#   This program moves the telescope to the parking position avoiding the sun during the motion.
...
alt=driver_params["safety_parameters"]["parking_alt"]
az=driver_params["safety_parameters"]["parking_az"]
