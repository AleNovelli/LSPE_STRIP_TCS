...
def main():
    ...
    controller_ip = driver_params["ip&ports"]["alt_controller_ip"]
    controller_port = driver_params["ip&ports"]["alt_controller_port"]

    proxy_ip = driver_params["ip&ports"]["alt_proxy_ip"]
    proxy_port = driver_params["ip&ports"]["alt_proxy_port"]
    ...
    print(full_ip_az_proxy, "->", full_ip_az_controller)
